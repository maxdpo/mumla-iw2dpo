...
App name on the device: Mumla Beta IW2DPO
Android Package (applicationId): se.lublin.mumla.beta — can be
installed alongside the official version of Mumla, without
conflicts.
